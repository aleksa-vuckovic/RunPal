...
class GroupRunViewModel @Inject constructor(
    ...
    init {
        viewModelScope.launch {
            ...
            val run = Run(user = email, id = Run.UNKNOWN_ID, room = roomID)
            ...
            try {
                ...
                val user = tryRepeat { combinedUserRepository.getUser(email) }
                _room.value = room
    ...
    fun updateLocation(loc: Location) {
        ...
        mapState.adjustCamera(localRunState.location)
    }
    ...
    fun centerSwitch() {
        ...
        mapState.adjustCamera(localRunState.location, DEFAULT_ZOOM)
    }
